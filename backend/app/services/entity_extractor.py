...
ПАРАМЕТР X — только в единицах таблицы СБЦП, не в единицах ТЗ:
  ...
  Таблица 10 (ОС канализации) — содержит НЕСКОЛЬКО независимых подтипов,
    каждый — отдельная позиция сметы:
    • Биологическая очистка городских сточных вод (п.1–п.13)    → тыс. м³/сут
    • Очистка ливневых и талых вод (п.14–п.17)                  → тыс. м³/сут
    • Доочистка городских сточных вод на фильтрах (п.25–п.37)  → тыс. м³/сут
      ДОБАВЛЯТЬ если ТЗ упоминает: «доочистку», «ступень доочистки»,
      «фильтры доочистки», сброс в рыбохозяйственный водоём + НДТ/ПДК
      по Росрыболовству, требования ИТС10-2019 по глубокой очистке.
      X = та же производительность КОС, что и у биологической очистки.
    • Глубокая очистка на биореакторах (п.38–п.40)              → тыс. м³/сут
    • Аэробная стабилизация осадка (п.1–п.5 в блоке стабилизации) → тыс. м³/сут (по воде)
    • Механическое обезвоживание осадка (п.6–п.10)              → т/сут (по сухому в-ву)
  Таблица 11 (Обработка осадка, термич./анаэроб.)  → т/сут (сухого вещества)
...
ОДИН ТЗ → НЕСКОЛЬКО СТРОК СБЦП:
  ...
  КОС с доочисткой → минимум две позиции: биологическая очистка + доочистка на фильтрах.
