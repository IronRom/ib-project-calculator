...
CONDITIONS = [
    ...
    # п.2.4: пп.8-12,13-22,28-33: до 1,07 (<80 тыс.м³/сут) или до 1,11 (>80 тыс.м³/сут)
    (4, "п.8-12, 13-22, 28-33", "Микропроцессорные контроллеры / АСУ (производительность до 80 тыс. м³/сут)", "multiplier_range", 1.04, 1.07, "asu"),
    (4, "п.8-12, 13-22, 28-33", "Микропроцессорные контроллеры / АСУ (производительность более 80 тыс. м³/сут)", "multiplier_range", 1.07, 1.11, "asu"),
    ...
    # Примечание: в п.2.8 СБЦП 81-2001-17 нет коэффициента АСУ для таблицы 8
    ...
    # п.2.10: пп.25-28: 1,09-1,11; пп.29-37: 1,18-1,2
    (10, "п.25-28", "Микропроцессорные контроллеры / АСУ на КОС (пп.25-28)", "multiplier_range", 1.09, 1.11, "asu"),
    (10, "п.29-37", "Микропроцессорные контроллеры / АСУ на КОС (пп.29-37)", "multiplier_range", 1.18, 1.20, "asu"),
